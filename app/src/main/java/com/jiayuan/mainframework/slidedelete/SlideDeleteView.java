...
public class SlideDeleteView extends ViewGroup {
    ...
    public SlideDeleteView setIos(boolean ios) {
        this.isIos = ios;
        return this;
    }
    ...
    public SlideDeleteView setLeftSwipe(boolean leftSwipe) {
        this.isLeftSwipe = leftSwipe;
        return this;
    }

    public static SlideDeleteView getViewCache() {
        return mViewCache;
    }
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.getTheme().obtainStyledAttributes(attrs, R.styleable.SlideDeleteView, defStyleAttr, 0);
        int count = ta.getIndexCount();

        for (int i = 0; i < count; ++i) {
            int attr = ta.getIndex(i);
            if (attr == R.styleable.SlideDeleteView_swipeEnable) {
                this.isSwipeEnable = ta.getBoolean(attr, true);
            } else if (attr == R.styleable.SlideDeleteView_ios) {
                this.isIos = ta.getBoolean(attr, true);
            } else if (attr == R.styleable.SlideDeleteView_leftSwipe) {
    ...
    public void smoothExpand() {
        ...
        this.mExpandAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator animation) {
                SlideDeleteView.this.scrollTo(((Integer) animation.getAnimatedValue()).intValue(), 0);
            }
        });
        ...
        this.mExpandAnim.addListener(new AnimatorListenerAdapter() {
            public void onAnimationEnd(Animator animation) {
                SlideDeleteView.this.isExpand = true;
            }
        });
    ...
    public void smoothClose() {
        ...
        this.mCloseAnim.addListener(new AnimatorListenerAdapter() {
            public void onAnimationEnd(Animator animation) {
                SlideDeleteView.this.isExpand = false;
            }
        });
